...
#pragma alias
using str = string;using strv = string_view;using ll = long long;using ld = long double;using vi = vector<int>;using vvi = vector<vi>;using vll = vector<ll>;using vb = vector<bool>;using pii = pair<int, int>;using vpii = vector<pii>;using cphro = int;constexpr long long MOD = 1e9 + 7;constexpr long double PI = acos(-1.0);constexpr int INF = 1e9;constexpr ll LINF = 1e18;
#pragma setup
    #pragma GCC target("avx2,popcnt,lzcnt,abm,bmi,bmi2,fma,tune=native")
    #pragma GCC optimize("O3,unroll-loops")
static const auto __PROGRAM_START_TIME = chrono::steady_clock::now();static const auto __SET_IO = [] { ios_base::sync_with_stdio(false); cin.tie(NULL); return 0;}();
#pragma dbg
#ifdef LOCAL_DBG
